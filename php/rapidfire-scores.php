...
if ( !class_exists( 'RapidFireScores' ) ) {
    class RapidFireScores extends RapidFireModel
    {
...
if ( class_exists( 'RapidFireScores' ) ) {
    global $rapidFireScores;
    $rapidFireScores = new RapidFireScores();
}

?>

<div class="wrap rapidFire scoreList">
    <h2>RapidFire Scores for "<?php $rapidFireScores->quiz_name(); ?>"</h2>

    <?php $rapidFireScores->show_alert_messages(); ?>
    ...
    <table id="record_view" class="wp-list-table widefat quiz_scores">
        <thead>
         ...
         <tbody>
            <?php $rapidFireScores->list_all_scores(); ?>
        </tbody>
    </table>
    <div class="tablenav bottom">
        <div class="tablenav-pages one-page"><span class="displaying-num"><?php $rapidFireScores->get_score_count() ?> item</span>
    </div>
</div>
