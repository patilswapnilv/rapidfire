...
if ( !class_exists( 'RapidFireNew' ) ) {
    class RapidFireNew extends RapidFireModel
    {
...
<script type="text/javascript">
    var disableRanking = <?php echo( $rapidFireNew->get_admin_option( 'disable_ranking' ) == '1' ? 'true' : 'false' ); ?>;
</script>
