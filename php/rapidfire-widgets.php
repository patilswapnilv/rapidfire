...
if ( !class_exists( 'RapidFireScoreWidget' ) ) {
    class RapidFireScoreWidget extends WP_Widget
    {
        ...
        {
            parent::__construct(
                'rapidfire_topscores', // Base ID
                'RapidFire Top Scores', // Name
                array( 'description' => __( 'Lists top scores for a designated RapidFire.', 'text_domain' ) ) // Args
            );
        }
    ...
    function register_rapidfire_score_widget() {
        register_widget( 'RapidFireScoreWidget' );
    }
    add_action( 'widgets_init',  'register_rapidfire_score_widget' );
}
