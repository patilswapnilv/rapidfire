...
if ( !class_exists( 'RapidFireModel' ) ) {
    class RapidFireModel extends RapidFireHelper
    {
        ...
        {
            global $wpdb;
            $db_name = $wpdb->prefix . 'plugin_rapidfire';
        ...
        {
            global $wpdb;
            $db_name = $wpdb->prefix . 'plugin_rapidfire_scores';
        ...
        /**
         * Apply WordPress filters to RapidFire JSON on output.
         *
