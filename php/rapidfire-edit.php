...
if ( !class_exists( 'RapidFireEdit' ) ) {
    class RapidFireEdit extends RapidFireModel
    {
...
if ( class_exists( 'RapidFireEdit' ) ) {
    global $rapidFireEdit;
    $rapidFireEdit = new RapidFireEdit();
}

?>
<div class="wrap rapidFire rapidFireWrapper">
    <?php $rapidFireEdit->show_alert_messages(); ?>

    <h2 class="notPublished">Edit Quiz</h2>

    <div class="floatLeft">
        <p class="statusLegend">
            <strong>Status:</strong> &nbsp;&nbsp;&nbsp; <?php $rapidFireEdit->get_quiz_status_info(); ?>
        </p>
    ...
    <div class="floatRight">
        <div class="top_button_bar">
            <?php if ( $rapidFireEdit->show_discard_option() ) { ?>
            ...
            <?php } ?>
            <a class="button" href="<?php echo admin_url( 'admin.php?page=rapidfire' ); ?>" title="Cancel this action">
...
<script type="text/javascript">
    var quizJSON = <?php $rapidFireEdit->get_quiz_json(); ?>;
    var disableRanking = <?php echo( $rapidFireEdit->get_admin_option( 'disable_ranking' ) == '1' ? 'true' : 'false' ); ?>;
</script>
