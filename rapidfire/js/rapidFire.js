/*!
 * RapidFire jQuery Plugin
 * http://github.com/jewlofthelotus/RapidFire
 *
...
(function($){
    $.rapidFire = function(element, options) {
        var plugin   = this,
            $element = $(element),
        ...
        // Set via json option or quizJSON variable (see rapidFire-config.js)
    ...
    $.fn.rapidFire = function(options) {
        return this.each(function() {
            if (undefined === $(this).data('rapidFire')) {
                var plugin = new $.rapidFire(this, options);
                $(this).data('rapidFire', plugin);
            }
        });
    };
})(jQuery);
