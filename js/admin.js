jQuery(document).ready(function($) {
    ...
    var imagePath = location.pathname.replace(/wp-admin.*/, 'wp-content/plugins/rapidfire/images/');
    ...
    $.setupQuizForm = function(element, options) {
        ...
        plugin.formListener = {
            ...
            preview: function(element) {
                ...
                if (formJSON == pubJSON) {
                    var previewUrl = location.replace('rapidfire-edit', 'rapidfire-preview');
                    window.open(previewUrl, 'quizPreview', 'resizable=1,width=900,height=700,scrollbars=1');
                    return false;
                }

                var postAction = location.match('rapidfire-new') ? 'create_draft_quiz' : 'update_draft_quiz';

                plugin.formHelper.saveQuiz(formJSON, postAction, false, function(data){
                    if (location.match('rapidfire-new')) {
                        window.location = location.replace('rapidfire-new', 'rapidfire-edit') + '&id=' + data;
                        var previewUrl  = location.replace('rapidfire-new', 'rapidfire-preview') + '&id=' + data;
                    } else {
            ...
            draft: function() {
                ...
                plugin.formHelper.saveQuiz(formJSON, postAction, false, function(data){
                    if (location.match('rapidfire-new')) {
                        window.location = location.replace('rapidfire-new', 'rapidfire-edit') + '&id=' + data + '&success';
                    } else {
            ...
            publish: function() {
                ...
                var location   = window.location.pathname + window.location.search;
                var postAction = location.match('rapidfire-new') ? 'create_published_quiz' : 'update_published_quiz';
                ...
                plugin.formHelper.saveQuiz(formJSON, postAction, confirmStr, function(data){
                    window.location = adminPath + 'admin.php?page=rapidfire&success';
                });
            },
        ...
        plugin.formHelper = {
            ...
            saveQuiz: function(formJSON, actionName, confirmMsg, callback) {
                actionUrl = window.location.pathname
                                ...
                                .replace('rapidfire-preview', 'rapidfire-publish')
            ...
            unpublishQuiz: function(element) {
                ...
                if (confirm(unpublishMsg)) {
                    $.ajax({
                        ...
                        success:  function(data) {
                            window.location = adminPath + 'admin.php?page=rapidfire&unpublish';
                        }
                    });
                }
            },
            ...
            deleteQuiz: function(element) {
                ...
                if (confirm(deleteMsg)) {
                    $.ajax({
                        ...
                        url:      $(element).attr('href'),
                        success:  function(data) {
                            window.location = adminPath + 'admin.php?page=rapidfire&delete';
                        }
                    });
                }
            }
